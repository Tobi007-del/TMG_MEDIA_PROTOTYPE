...
TMG is a TypeScript video player replacing beta: `src/beta/beta.js`. The architecture is **S.I.A. (State & Intent Architecture)** - a plug-based, reactive, infinitely extensible core. Goal is a paradigm shift, not an MVP. Think before coding.
