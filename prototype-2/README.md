...
[Live Demo](https://tmg-video-player.vercel.app) | [Prototype 1](https://tobi007-del.github.io/tmg-media-player/prototype-1/index.html) | [Prototype 2](https://tobi007-del.github.io/tmg-media-player/prototype-2/index.html)
...
- **[Prototype 1](https://tobi007-del.github.io/tmg-media-player/prototype-1/index.html)** - Basic initial implementation
- **[Prototype 2](https://tobi007-del.github.io/tmg-media-player/prototype-2/index.html)** - Full Featured player
...
- **Prototype 1**: `http://localhost:8000/prototype-1/index.html`
- **Prototype 2**: `http://localhost:8000/prototype-2/index.html`
...
<html>
  <head>
    <script src="prototype-2/index.js" defer></script>
  </head>
  <body>
...
1. Open `prototype-2/index.html` or your html file in browser
...
1. **Start Simple**: Review `prototype-1/index.js` (751 lines)
2. **Type Definitions**: Study `prototype-2/build.ts` for structure
3. **Main Implementation**: Dive into `prototype-2/index.js`
