...
var tmg = {
  ...
  bindAllMethods(owner, callback = (method, owner) => (owner[method] = owner[method].bind(owner))) {
    let proto = owner;
  ...
  rippleHandler(e, target, forceCenter = false) {
    ...
    const release = () => {
      ...
      ["pointerup", "pointercancel"].forEach((e) => tmg.getWindow(el)?.removeEventListener(e, release));
    };
