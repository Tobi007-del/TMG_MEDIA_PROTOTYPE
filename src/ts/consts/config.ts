...
import { AUTO_BUILD, CSS_BUILD, BRIGHTNESS_BUILD, CAPTIONS_BUILD, CONTROL_PANEL_BUILD, ERROR_MESSAGES_BUILD, FAST_PLAY_BUILD, GESTURE_BUILD, KEYS_BUILD, LOCKED_BUILD, MODES_BUILD, OBJECT_FIT_BUILD, OVERLAY_BUILD, PERSIST_BUILD, PLAYBACK_RATE_BUILD, TIME_BUILD, FRAME_BUILD, TOASTS_BUILD, VOLUME_BUILD, PLAYS_INLINE_BUILD, LIGHT_STATE_BUILD, MEDIA_BUILD, DISABLED_BUILD } from "../plugs";
