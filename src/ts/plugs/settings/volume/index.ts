import { BasePlug, type KeysPlug, type KeyMod, Volume, VolumeState, VOLUME_BUILD } from "../..";
...
export class VolumePlug extends BasePlug<Volume, VolumeState> {
  ...
  public override wire(): void {
    ...
    // ---- Media Setters
    this.media.set("intent.volume", (value) => clamp(this.config.min, value, this.config.max), { signal: this.signal });
    // ----------- Watchers
