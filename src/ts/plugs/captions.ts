...
export class CaptionsPlug extends BasePlug<Captions> {
  ...
  public override wire(): void {
    ...
    STYLE_PROPS.forEach((prop) => this.ctlr.config.watch(`settings.captions.${prop}.value`, (value) => ((this.ctlr.settings.css[camelize(`captions.${prop}`, /\./)] = value), this.view?.syncSize()), { signal: this.signal, immediate: true }));
    // ---- Media Listeners
