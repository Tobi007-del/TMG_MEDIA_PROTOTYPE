...
export class Reactor<T extends object> {
  ...
  public config: Omit<ReactorOptions<T>, "debug" | "referenceTracking" | "lineageTracing" | "smartCloning"> = { crossRealms: false, eventBubbling: true, batchingFunction: R_BATCH };
